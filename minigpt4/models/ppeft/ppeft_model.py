...
from .pconfig import PeftConfig
from .plora import PLoraModel
...
# 兼容不同版本的 peft：add_library_to_model_card 在低版本中不存在
try:
    from peft.utils import add_library_to_model_card  # type: ignore
except Exception:
    def add_library_to_model_card(*args, **kwargs):  # type: ignore
        return None


PEFT_TYPE_TO_MODEL_MAPPING = {
    PeftType.LORA: PLoraModel,
    ...
    **Attributes**:
    ...
    def from_pretrained(
        ...
        **kwargs: Any,
        ...
        """
        from .pmapping import MODEL_TYPE_TO_PEFT_MODEL_MAPPING, PEFT_TYPE_TO_CONFIG_MAPPING
    ...
    def load_adapter(self, model_id: str, adapter_name: str, is_trainable: bool = False, **kwargs: Any):
        from .pmapping import PEFT_TYPE_TO_CONFIG_MAPPING
    ...
    def forward(
        ...
        **kwargs,
        ...
        if not peft_config.is_prompt_learning:
            ...
            if ui_embedding is not None:
                weight = self.base_model.weight_generator(ui_embedding)
            else:
